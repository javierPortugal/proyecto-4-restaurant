...
function Footer({titulo="Subscribete to our news letter"}) {
    return ( 
        <div className="container">
            <footer className="py-5">
                <div className="row">
                    <div className="col-6 col-md-2 mb-3">
                        <h5>Mexicana Típica</h5>
                    ...
                    <div className="col-md-5 offset-md-1 mb-3">
                        <form>
                        <h5>{titulo}</h5>
                        <p>Noticias mensuales de nuestros nuevos platillos!!.....</p>
